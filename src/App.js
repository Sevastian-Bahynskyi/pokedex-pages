...
import PokeFullCard from './components/PokeFullCard';
		...
		<div className="App-main">
			...
			<div className="App-control-panel">
				...
				<div className="App-pagination-buttons">
					<Button
						className="App-pagination-button App-pagination-button-previous"
					...
					<Button
						className="App-pagination-button App-pagination-button-next"
